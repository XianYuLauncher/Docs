...
3. 可以选择：
   ...
   - 最新快照版
   - 其它版本
4. 选择版本后，点击 Minecraft 下载页的「下载」按钮
5. 等待下载完成

<OpenInLauncherCard
  href="xianyulauncher://open?page=resource-download"
  title="在启动器中下载 Minecraft 版本"
  description="点击跳转至启动器资源下载页"
/>

## 安装加载器（可选）

如果您想要安装 Mod，可选择安装加载器：

1. 在下载版本时，选择加载器
2. 在加载器选项中，选择要安装的加载器：Forge / Fabric / Neoforge / Quilt
3. 选择加载器版本
4. 点击「下载」按钮
5. 等待下载和安装完成
