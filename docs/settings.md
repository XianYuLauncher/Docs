...
在启动器主界面，点击侧边栏底部的「设置」图标即可进入。设置页面按功能分为多个板块，涵盖游戏运行、外观、下载、Launcher AI 等，可根据需要调整。
...
**版本隔离**：开启后，每个版本使用独立的游戏目录，Mod 与存档互不干扰。
...
**Mod 隐藏快照版本**：开启后隐藏快照、预发布版与候选版，仅显示稳定版。
...
**Launcher AI**：启用后可使用第三方 AI 服务分析崩溃日志、安装模组、启动游戏等操作，需自行配置 API 端点与密钥。

<OpenInLauncherCard
  href="xianyulauncher://open?page=settings&section=launcher-ai"
  title="在启动器中打开「Launcher AI」"
  description="点击跳转至启动器设置 → Launcher AI"
/>
